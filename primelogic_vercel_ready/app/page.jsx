    ...
    <div className="min-h-screen bg-[#080808] text-white">
      <header className="sticky top-0 z-20 border-b border-white/10 bg-[#080808]/80 backdrop-blur-xl">
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
          <a href="/" className="flex items-center gap-3">
            <div className="w-11 h-11 rounded-2xl bg-[#D4AF37] text-black flex items-center justify-center font-black text-xl shadow-[0_0_30px_rgba(212,175,55,0.35)]">
              P
            </div>

            <div className="leading-tight">
              <div className="text-lg font-semibold tracking-[0.18em] uppercase">
                PrimeLogic <span className="text-[#D4AF37]">AI</span>
              </div>
          ...
          <a
            href={FORM_URL}
            className="px-6 py-2 rounded-full bg-[#D4AF37] text-black text-sm font-medium hover:bg-[#E7C75A] transition"
          >
            Angebot anfordern
          </a>
        </div>
      ...
      <main>
        <section className="text-center px-6 pt-28 pb-24">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-[#D4AF37]/30 bg-white/5 text-xs text-[#D4AF37]">
            <span className="w-2 h-2 rounded-full bg-[#D4AF37]" />
            KI-Chatbots & Telefon-Assistenten für Unternehmen
          </div>

          <h1 className="mt-8 text-5xl md:text-7xl font-light leading-tight tracking-tight">
            Mehr Anfragen.
            <br />
            Weniger Aufwand.
          </h1>
          ...
          <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href={FORM_URL}
              className="px-8 py-4 rounded-full bg-[#D4AF37] text-black font-medium hover:bg-[#E7C75A] transition"
            >
              Jetzt starten
            </a>
        ...
        <section className="max-w-6xl mx-auto px-6 py-20">
          ...
          <div className="mt-12 grid md:grid-cols-2 gap-6">
            <div className="rounded-[28px] border border-white/10 bg-white/[0.03] p-6">
              <p className="text-sm text-white/45 mb-5">Website-Chatbot</p>
            ...
            <div className="rounded-[28px] border border-[#D4AF37]/25 bg-[#111111] p-6">
              <p className="text-sm text-[#D4AF37] mb-5">
        ...
        <section id="pakete" className="max-w-6xl mx-auto px-6 py-20">
          ...
          <div className="mt-10 grid md:grid-cols-2 gap-6">
            <div className="rounded-[28px] border border-white/10 bg-white/[0.03] p-7">
              <p className="text-xs text-[#D4AF37] font-medium">Starter</p>
              ...
              <div className="mt-5 rounded-2xl bg-white/5 border border-white/10 p-5">
                <p className="text-xs text-white/45">Einrichtung</p>
            ...
            <div className="rounded-[28px] border border-[#D4AF37]/30 bg-[#D4AF37] text-black p-7">
              ...
              <div className="mt-5 rounded-2xl bg-black/10 p-5">
                <p className="text-xs text-black/60">Einrichtung</p>
                <p className="text-3xl font-semibold">4.999 €</p>
